(() => {
  ...
  var other_default = () => {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(app_default, null), /* @__PURE__ */ React.createElement("div", {
      onClick: () => setCount((prev) => prev + 1)
    }, "Other: Counter: ", count));
  };

  // react-hydrate.jsx
  ReactDOM.hydrate(/* @__PURE__ */ React.createElement(other_default, null), document.getElementById("root"));
})();
